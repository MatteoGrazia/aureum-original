...
const ICONS = [
  {
    ...
    exercises: [
      ...
      { exercise_name: 'Plank', sets: 4, reps: '20' },
    ],
  },
  {
    name: 'Chris Bumstead',
    split: 'Cbum PPL (Push Focus)',
    ...
    fst7Note: 'Set 4 is FST-7: 7 sets of Pec Deck with only 30 seconds rest between sets.',
    exercises: [
      { exercise_name: 'Bench Press', sets: 3, reps: '5-8 / 10-12' },
      { exercise_name: 'Close Grip Bench Press', sets: 3, reps: '8-10' },
      { exercise_name: 'Barbell Overhead Press', sets: 3, reps: '10-12' },
      { exercise_name: 'Pec Deck Machine', sets: 3, reps: '10-40s' },
      { exercise_name: 'Lateral Raise', sets: 4, reps: '12' },
    ],
  },
  {
    name: 'Ronnie Coleman',
    split: "King's Mass (Back/Bi)",
    era: '8× Mr. Olympia',
    focus: ['back', 'biceps'],
    ...
    exercises: [
      ...
      { exercise_name: 'Barbell Row', sets: 4, reps: '10-12' },
      { exercise_name: 'T-Bar Row', sets: 4, reps: '10-12' },
      { exercise_name: 'Single Arm Dumbbell Row', sets: 3, reps: '10-12' },
      { exercise_name: 'Barbell Curl', sets: 4, reps: '12' },
    ],
  },
  {
    name: 'Jay Cutler',
    split: 'FST-7 Engine (Chest/Tri)',
    era: '4× Mr. Olympia',
    focus: ['chest', 'triceps'],
    ...
    fst7Note: 'Set 4 is FST-7: 7 sets of Cable Crossovers with only 30 seconds rest between sets.',
    exercises: [
      { exercise_name: 'Incline Dumbbell Press', sets: 3, reps: '8-12' },
      { exercise_name: 'Dumbbell Chest Press', sets: 3, reps: '8-12' },
      { exercise_name: 'Cable Fly', sets: 3, reps: '8-12' },
      { exercise_name: 'Cable Fly', sets: 7, reps: '12 (30s rest)' },
      { exercise_name: 'Tricep Dip', sets: 3, reps: '8-12' },
    ],
  },
  {
    name: 'Frank Zane',
    split: 'Aesthetic Symmetry (Legs)',
    era: '3× Mr. Olympia',
    focus: ['legs', 'calves'],
    ...
    exercises: [
      { exercise_name: 'Squat', sets: 6, reps: '8-15' },
      { exercise_name: 'Leg Press', sets: 3, reps: '10-15' },
      { exercise_name: 'Leg Curl', sets: 3, reps: '10-12' },
      { exercise_name: 'Leg Extension', sets: 3, reps: '8-12' },
      { exercise_name: 'Standing Calf Raise', sets: 3, reps: '15-20' },
    ],
  },
  {
    name: 'Dorian Yates',
    split: 'Blood & Guts (Back)',
    era: '6× Mr. Olympia',
    focus: ['back'],
    ...
    hitRoutine: true,
    exercises: [
      { exercise_name: 'Lat Pulldown', sets: 1, reps: '8-10 to failure', isWorkingSet: true },
      { exercise_name: 'Barbell Row', sets: 1, reps: '8-10 to failure', isWorkingSet: true },
      { exercise_name: 'Single Arm Dumbbell Row', sets: 1, reps: '8-10 to failure', isWorkingSet: true },
      { exercise_name: 'Seated Cable Row', sets: 1, reps: '8-10 to failure', isWorkingSet: true },
      { exercise_name: 'Deadlift', sets: 2, reps: '8 to failure', isWorkingSet: true },
    ],
  },
  {
    name: 'Sergio Oliva',
    split: 'Myth Volume (Chest/Back)',
    era: '3× Mr. Olympia',
    ...
    exercises: [
      ...
      { exercise_name: 'Chest Dip', sets: 5, reps: '15' },
      { exercise_name: 'Barbell Overhead Press', sets: 5, reps: '12' },
      { exercise_name: 'Barbell Row', sets: 5, reps: '10' },
    ],
  },
  {
    name: 'Franco Columbu',
    split: 'Sardinian Strength (Legs)',
    era: '2× Mr. Olympia',
    focus: ['legs'],
    ...
    exercises: [
      { exercise_name: 'Squat', sets: 7, reps: '20/15/10/8/6/4/2' },
      { exercise_name: 'Leg Press', sets: 4, reps: '50/25/15/8' },
      { exercise_name: 'Leg Extension', sets: 6, reps: '20' },
      { exercise_name: 'Walking Lunge', sets: 3, reps: '12' },
    ],
  },
  {
    name: 'Mike Mentzer',
    split: 'Consolidation HIT (Full Body)',
    ...
    hitRoutine: true,
    exercises: [
      { exercise_name: 'Leg Press', sets: 1, reps: '12-20 to failure', isWorkingSet: true },
      { exercise_name: 'Standing Calf Raise', sets: 1, reps: '12-20 to failure', isWorkingSet: true },
      { exercise_name: 'Lat Pulldown', sets: 1, reps: '6-10 to failure', isWorkingSet: true },
      { exercise_name: 'Tricep Pushdown', sets: 1, reps: '6-10 to failure', isWorkingSet: true },
      { exercise_name: 'Chest Dip', sets: 1, reps: '6-10 to failure', isWorkingSet: true },
    ],
  },
  {
    name: 'Tom Platz',
    split: 'Leg-Day Cult (Legs)',
    era: 'IFBB Pro Legend',
    focus: ['legs'],
    ...
    exercises: [
      { exercise_name: 'Squat', sets: 10, reps: '5-20 to failure' },
      { exercise_name: 'Hack Squat', sets: 5, reps: '15' },
      { exercise_name: 'Leg Extension', sets: 8, reps: '10-15' },
  ...
  // ── Female Icons ──────────────────────────────────────────────────────────
  {
    ...
    exercises: [
      { exercise_name: 'Incline Dumbbell Press', sets: 3, reps: '12-15' },
      { exercise_name: 'Lateral Raise', sets: 3, reps: '15' },
      { exercise_name: 'Pull-ups', sets: 3, reps: 'Max' },
      { exercise_name: 'Dumbbell Curl', sets: 3, reps: '12' },
      { exercise_name: 'Tricep Pushdown', sets: 3, reps: '12' },
    ],
  },
  {
    name: 'Cory Everson',
    split: 'Athletic PPL (Legs)',
    era: '6× Ms. Olympia',
    focus: ['legs', 'calves'],
    focusColor: '#BDB5D5',
    ...
    exercises: [
      ...
      { exercise_name: 'Leg Press', sets: 4, reps: '12' },
      { exercise_name: 'Standing Calf Raise', sets: 3, reps: '15-25' },
      { exercise_name: 'Seated Calf Raise', sets: 3, reps: '15-25' },
    ],
  },
  {
    name: 'Lenda Murray',
    split: 'Proportionalist (Back)',
    era: '8× Ms. Olympia',
    focus: ['back'],
    focusColor: '#BDB5D5',
    ...
    exercises: [
      { exercise_name: 'Barbell Row', sets: 4, reps: '10' },
      { exercise_name: 'Lat Pulldown', sets: 4, reps: '12' },
      { exercise_name: 'Single Arm Dumbbell Row', sets: 3, reps: '12' },
      { exercise_name: 'Seated Cable Row', sets: 3, reps: '12' },
    ],
  },
  {
    name: 'Iris Kyle',
    split: '10-Time Blueprint (Legs)',
    era: '10× Ms. Olympia',
    focus: ['legs'],
    focusColor: '#BDB5D5',
    ...
    exercises: [
      { exercise_name: 'Leg Press', sets: 4, reps: '15-20' },
      { exercise_name: 'Hack Squat', sets: 4, reps: '12' },
      { exercise_name: 'Squat', sets: 3, reps: '12' },
      { exercise_name: 'Leg Extension', sets: 4, reps: '20' },
      { exercise_name: 'Leg Curl', sets: 4, reps: '15' },
    ],
  },
  {
    name: 'Dana Linn Bailey',
    split: '100-Rep Chaos (Back)',
    ...
    repVolumeRoutine: true,
    exercises: [
      { exercise_name: 'Lat Pulldown', sets: 1, reps: '100 total reps' },
      { exercise_name: 'Barbell Row', sets: 1, reps: '100 total reps' },
      { exercise_name: 'Seated Cable Row', sets: 1, reps: '100 total reps' },
      { exercise_name: 'Tricep Pushdown', sets: 1, reps: '50 reps' },
      { exercise_name: 'Cable Fly', sets: 1, reps: '50 reps' },
    ],
  },
];
      ...
      <AnimatePresence>
        {selected && (
          ...
          >
            ...
            {/* HIT / Rep-Volume badge */}
            {(selected.hitRoutine || selected.repVolumeRoutine || selected.fst7Note) && (
              <div className="px-5 pb-3">
                <div className="px-3 py-2 rounded-xl text-xs" style={{ background: selected.repVolumeRoutine ? 'rgba(189,181,213,0.08)' : 'rgba(212,175,55,0.07)', border: `0.5px solid ${selected.repVolumeRoutine ? 'rgba(189,181,213,0.3)' : 'rgba(212,175,55,0.25)'}`, color: selected.repVolumeRoutine ? '#BDB5D5' : '#D4AF37', fontFamily: 'Montserrat', fontWeight: 300, lineHeight: 1.5 }}>
                  {selected.hitRoutine && '⚡ HIT Protocol — each highlighted set is taken to absolute muscular failure. No more, no less.'}
                  {selected.repVolumeRoutine && '🔁 100-Rep Method — rest 20-30s mid-set until total reps are reached. No fixed sets.'}
                  {selected.fst7Note && selected.fst7Note}
                </div>
              </div>
            )}
                ...
                {selected.exercises.map((ex, i) => {
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        background: ex.isWorkingSet ? 'rgba(189,181,213,0.08)' : 'rgba(255,255,255,0.04)',
                        border: ex.isWorkingSet ? '0.5px solid rgba(189,181,213,0.35)' : '0.5px solid rgba(212,175,55,0.1)',
                      }}
                    >
                      ...
                      >
                        {imgUrl ? (
                          ...
                          <span style={{ color: ex.isWorkingSet ? '#BDB5D5' : '#D4AF37', fontFamily: 'Montserrat', fontSize: 13 }}>{i + 1}</span>
                        )}
                      </div>
                      <div className="flex-1">
                        <p className="text-sm" style={{ color: ex.isWorkingSet ? '#BDB5D5' : '#E5E5E7', fontFamily: 'Montserrat', fontWeight: 300 }}>
                          {ex.exercise_name}
                        </p>
                        {ex.isWorkingSet && (
                          <p className="text-[9px] uppercase tracking-wider mt-0.5" style={{ color: 'rgba(189,181,213,0.6)', fontFamily: 'Montserrat' }}>Working Set — to failure</p>
                        )}
                      </div>
                      <span className="text-xs flex-shrink-0" style={{ color: ex.isWorkingSet ? '#BDB5D5' : '#D4AF37', fontFamily: 'Montserrat' }}>
                        {ex.sets} × {ex.reps}
                      </span>
                    </motion.div>
                  );
