...
export default function StepCounter({ steps, goal }) {
  ...
  return (
    <div 
      ...
      style={{
        background: isDarkMode ? 'rgba(255, 255, 255, 0.03)' : 'rgba(255, 248, 220, 0.52)',
        backdropFilter: 'blur(24px) saturate(200%)',
        boxShadow: isDarkMode ? '0 20px 50px rgba(0, 0, 0, 0.6)' : '0 8px 32px rgba(180, 130, 30, 0.13)',
        border: `0.5px solid rgba(212, 175, 55, ${isDarkMode ? '0.1' : '0.32'})`,
        padding: '20px 18px',
        borderRadius: '14px'
      }}
    >
